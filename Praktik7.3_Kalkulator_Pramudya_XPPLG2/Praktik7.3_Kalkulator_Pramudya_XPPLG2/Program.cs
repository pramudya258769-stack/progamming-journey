...
namespace Praktik7._3_Kalkulator_Pramudya_XPPLG2
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("--- KALKUATOR SEDERHANA ---");

                // Memanggil fungsi untuk menampilkan menu
                TampilkanMenu();

                Console.WriteLine("Masukkan pilihan operasi (1-4): ");
